...
- Name: smoke.spec.ts >> mobile >> menu trigger opens the drawer
- Location: e2e/smoke.spec.ts:83:7
...
Locator: getByTestId('nav-menu-trigger')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('nav-menu-trigger')
